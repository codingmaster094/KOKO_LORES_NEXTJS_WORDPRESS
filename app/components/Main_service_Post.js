    ...
    <section className="brunch-post">
      {content?.service_post_lists_repeater?.length > 0 &&
        ...
        const textColorClass = 
          items.services_post_lists_background_color_radio === "beige-light" || 
          items.services_post_lists_background_color_radio === "beige-red"
            ? "tx-black"
            : "tx-dark";
        ...
        return (
          <div
            className={`${items.services_post_lists_background_color_radio} 
              ${textColorClass} brunch-post-wrapper flex flex-wrap items-stretch`}
          ...
          >
            ...
            <div className={`brunch-post-content w-full lg:w-1/2 px-3.5 py-8 sm:px-14 xl:px-28 lg:py-8 sm:py-14 2xl:px-40 flex flex-col justify-center gap-4 sm:gap-6 ${contentPositionClass}`}>
              ...
              <Link
                ...
                className="btn b-btn rounded-full mt-7 sm:mt-0"
              >
